package io.kamailio.admin.modules.msilo;
...
@WebMvcTest(io.kamailio.admin.modules.msilo.controller.MsiloController.class)
class MsiloControllerTest extends ControllerTestBase {

    @MockBean
    private MsiloService service;
    ...
    void findAll_returnsOkWithCode0() throws Exception {
        ...
        ResultActions actions = mockMvc.perform(get("/api/msilo").param("page", "1").param("limit", "20"));
