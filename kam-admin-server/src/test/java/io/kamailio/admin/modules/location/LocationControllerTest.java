package io.kamailio.admin.modules.location;
...
@WebMvcTest(io.kamailio.admin.modules.location.controller.LocationController.class)
class LocationControllerTest extends ControllerTestBase {
    ...
    void findAll_returnsOkWithCode0() throws Exception {
        ...
        ResultActions actions = mockMvc.perform(get("/api/locations").param("page", "1").param("limit", "20"));
